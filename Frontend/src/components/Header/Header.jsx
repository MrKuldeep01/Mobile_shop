...
{/* function Li({title="Products 🎁", to="/", classes="", activeClasses="", text='All', icon=(<i className="ri-layout-masonry-fill"></i>)}) {} */}
            <Li title="Products 🎁" to="/" classes="" activeClasses="" text='All' icon={(<i className="ri-layout-masonry-fill"></i>)} />
            <Li title="category 👩‍⚖️" to="/category" classes="" activeClasses="" text='category' icon={(<i className="ri-equalizer-fill"></i>)} />
           
            <Li title="services 🛠" to="/services" classes="" activeClasses="" text='services' icon={(<i className="ri-tools-fill"></i>)} />
           
            <Li title="contact 🤝" to="/contact" classes="" activeClasses="" text='contact' icon={(<i className="ri-shake-hands-fill"></i>)} />          
          </div>
