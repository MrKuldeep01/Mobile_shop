...
import { FiMail, FiPhone, FiUser, FiMapPin, FiEdit2, FiUserX } from 'react-icons/fi'; // Import icons
    ...
    <div className="min-h-screen py-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          {/* Cover Image */}
          <div className="h-48 bg-gradient-to-r from-amber-500 to-amber-800">
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{userData?.gmail || "email@example.com"}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-800">{userData?.mobile || "Not provided"}</p>
                  </div>
                </div>
